...
class CourseService {
  ...
  //       QueryCourseDTO("1", "", userInfo.institute!, userInfo.classes!);
  ...
  //   var data = await SharedPreferencesUtils.getStorage(
  //       SharedPreferencesUtils.COURSE_LIST_KEY);
  //   if (data == null) {
  //     return [];
  //   }
  ...
  //  * 从服务器获取课表
  //  */
  // static Future<List<List<Lesson>>> getCourseListNetwork(
  //     QueryCourseDTO queryCourseDTO) async {
  //   var headers = await HttpUtils.createHeaders();
  //   var response = await CourseApi.queryCourseList(queryCourseDTO.toJson(),
  //       headers: headers);
  ...
  //       SharedPreferencesUtils.COURSE_LIST_KEY, courseList);
  // }
