...
class _MyHomePageState extends State<MyHomePageController> with SingleTickerProviderStateMixin{
    ...
    return CustomAnimatedBottomBar(
      ...
      items: <MyBottomNavigationBarItem>[
        ...
        MyBottomNavigationBarItem(
          ...
          title: Text(titles[1]),
          activeColor: const Color(0xffCC3399),
          inactiveColor: _inactiveColor,
          textAlign: TextAlign.center,
        ),
        MyBottomNavigationBarItem(
